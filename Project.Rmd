...
```
From the overlaid density plots we can see a strong correlation between the post-trial results, whereas the pre-trial results are more varied between reports.
