...
result_sw <- shapiro.test(patient_data$pre_trial_cpss)
result_sw
```

A `r result_sw$method` was conducted on the pre trial cpss data. From the output obtained we can assume normality as the p-value (p=`r round(result_sw$p.value, 4)`) is greater than 0.05.
