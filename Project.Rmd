...
plot(patient_data$pre_trial_cpss[1:50] ~ patient_data$post_trial_cpss[1:50], type="p",xlim = c(0,10), ylim = c(0,10), patient_data, main = "Self Reported Data - Static", xlab = "Pre-Trial Report", ylab = "Post Trial Report")

plot(patient_data$pre_trial_cpss[51:100] ~ patient_data$post_trial_cpss[51:100], type="p",xlim = c(0,10), ylim = c(0,10), patient_data, main = "Self Reported Data - Control", xlab = "Pre-Trial Report", ylab = "Post Trial Report")

plot(patient_data$pre_trial_cpss[101:150] ~ patient_data$post_trial_cpss[101:150], type="p",xlim = c(0,10), ylim = c(0,10), patient_data, main = "Self Reported Data - Animated", xlab = "Pre-Trial Report", ylab = "Post Trial Report")
